...
if TYPE_CHECKING:
    ...
    from hsml.deployment.inference_endpoint import InferenceEndpoint
...
class ModelServing:
    ...
    def create_feature_view_predictor(
        ...
        Parameters:
            ...
            script_file: A script subclassing `hsml.deployment.default_predictor.DefaultPredict` that ends with the `run_kserve_wrapper()` hand-over.
            resources: Resources to be allocated for the predictor.
            scaling_configuration: Scaling configuration for the predictor.
