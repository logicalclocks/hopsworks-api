...
@click.option(
    ...
    help=(
        ...
        "serve it from the Kubernetes path as well. Logs of stopped agents "
        "are retrieved with --download."
    ),
)
...
@click.option(
    ...
    is_flag=True,
    help=(
        "Download the HopsFS log archives written when the agent was "
