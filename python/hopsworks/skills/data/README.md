...
Data discovery, external data sources, Trino SQL, Spark, Delta table maintenance,
and Airflow orchestration. The live, canonical
list is `hops skills list --bucket data`.

- [hops-airflow](hops-airflow/SKILL.md) — Orchestrate Hopsworks jobs with Airflow: where DAG files must live and which operators exist.
