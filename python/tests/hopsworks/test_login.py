...
class TestLogin(TestCase):
    ...
    def _check_api_key_existence(self):
        ...
        home_api_key_path = "{}/{}/{}".format(
            home_dir_path, api_key_folder, api_key_name
        )

        # Path for tmp api key
        temp_dir_path = tempfile.gettempdir()
        temp_api_key_path = "{}/{}/{}".format(
            temp_dir_path, api_key_folder, api_key_name
        )
