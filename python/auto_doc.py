...
PAGES = {
    ...
    "api/projects.md": {
        ...
        "project_methods": keras_autodoc.get_methods(
            "hopsworks.project.Project", exclude=EXCLUDE_METHODS
        ),
    },
    "api/jobs.md": {
    ...
    "api/feature_api.md": {
        ...
        "feature_methods": keras_autodoc.get_methods("hsfs.feature.Feature", exclude=EXCLUDE_METHODS),
    },
    ...
    "api/feature_store_api.md": {
        ...
        "fs_methods": keras_autodoc.get_methods("hsfs.feature_store.FeatureStore", exclude=EXCLUDE_METHODS),
    },
