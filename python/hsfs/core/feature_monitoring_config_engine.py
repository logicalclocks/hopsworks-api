...
# Offline types accepted for a monitoring config's event_time feature,
...
class FeatureMonitoringConfigEngine:
    ...
    def _run_feature_monitoring(
        ...
        # Resolve the config's event_time feature name to a Feature object
        ...
        if model_filter is not None and event_time_feature is None:
            ...
            # it here in case a config created before event-time support reaches this job
            # without the field.
            from hsfs.feature import Feature
