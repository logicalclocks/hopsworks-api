...
class VectorServer:
    ...
    def init_serving(
        ...
        if not (self._all_parent_feature_groups_online or self._all_features_on_demand):
            ...
            not self._all_parent_feature_groups_online and self._all_features_on_demand
        ):
            warnings.warn(
    ...
    @property
    def _all_parent_feature_groups_online(self) -> bool:
        """True if all feature groups in the feature view are online."""
        if self.__all_feature_groups_online:
