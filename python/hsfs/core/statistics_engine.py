...
from hsfs import engine, split_statistics, statistics, util, decorators
...
class StatisticsEngine:
    ...
    @decorators.catch_not_found(["hsfs.statistics.Statistics", "hsfs.feature_group_commit.FeatureGroupCommit"], fallback_return=None)
