...
class InferenceServerException(Exception):
    ...
    def __init__(self, msg:str, status:str|None=None, debug_details:str|None=None):
        ...
        Parameters:
            msg: A brief description of error.
            status: The error code.
            debug_details: The additional details on the error.
        """
        self._msg = msg
        self._status = status
...
class InferInput:
    ...
    def __init__(
        ...
        shape: list,
        datatype: str,
        data: list | InferTensorContents | None = None,
    ...
    def set_data_from_numpy(self, input_tensor: np.ndarray, binary_data: bool = True):
        ...
        if not valid_shape:
            raise_error(
                f"got unexpected numpy array shape [{str(input_tensor.shape)[1:-1]}], expected [{str(self._shape)[1:-1]}]"
            )
...
class InferOutput:
    def __init__(
        ...
        """An object of InferOutput class is used to describe input tensor for an inference request.
