...
class MODEL_SERVING:
    ...
    # Set when the served feature view logs; the value is the transport the
    # rows take (realtime or job), which the deployment page keys off.
    FEATURE_LOGGING_ENV_VAR = "SERVING_FEATURE_LOGGING"
