...
@public("hopsworks.decorators.not_connected", "hsfs.decorators.not_connected", "hsml.decorators.not_connected")
...
@public("hopsworks.decorators.connected", "hsfs.decorators.connected", "hsml.decorators.connected")
def connected(fn):
    @functools.wraps(fn)
...
@public("hopsworks.decorators.catch_not_found", "hsfs.decorators.catch_not_found", "hsml.decorators.catch_not_found")
...
@public("hopsworks.decorators.HopsworksConnectionError", "hsfs.decorators.HopsworksConnectionError", "hsml.decorators.HopsworksConnectionError")
...
@public("hopsworks.decorators.NoHopsworksConnectionError", "hsfs.decorators.NoHopsworksConnectionError", "hsml.decorators.NoHopsworksConnectionError")
...
if os.environ.get("HOPSWORKS_RUN_WITH_TYPECHECK", False):
    ...
    @public("hopsworks.decorators.typechecked", "hsfs.decorators.typechecked", "hsml.decorators.typechecked")
    def typechecked(
        target: _T,
    ) -> _T:
...
@public("hopsworks.decorators.uses_great_expectations", "hsfs.decorators.uses_great_expectations", "hsml.decorators.uses_great_expectations")
