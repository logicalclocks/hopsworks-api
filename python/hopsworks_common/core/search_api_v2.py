...
from hopsworks_common.search_results_v2 import FeaturestoreSearchResult
...
```python
        ...
        result = search_api.featurestore("search-term", keyword_filter=["ml", "production"])

        # Search with tag filter as a single dictionary
        result = search_api.featurestore(
            "search-term",
        ...
        result = search_api.featurestore("search-term", tag_filter=tags)
