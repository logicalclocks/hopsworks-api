...
- [`TransformationFunction`][hsfs.transformation_function.TransformationFunction] - Wrapper for saved transformations
- [`HopsworksUdf`][hsfs.hopsworks_udf.HopsworksUdf] - Metadata container for UDFs
- [`TransformationType`][hsfs.transformation_function.TransformationType] - Enum for MDT vs ODT

### Statistics Classes

- [`TransformationStatistics`][hsfs.transformation_statistics.TransformationStatistics] - Declare statistics requirements
- [`FeatureTransformationStatistics`][hsfs.transformation_statistics.FeatureTransformationStatistics] - Access computed statistics

### Built-in Transformations

- [`min_max_scaler`][hsfs.builtin_transformations.min_max_scaler] - Scale to [0, 1]
- [`standard_scaler`][hsfs.builtin_transformations.standard_scaler] - Standardize (zero mean, unit variance)
- [`robust_scaler`][hsfs.builtin_transformations.robust_scaler] - Outlier-robust scaling
- [`label_encoder`][hsfs.builtin_transformations.label_encoder] - Encode categories as integers
- [`one_hot_encoder`][hsfs.builtin_transformations.one_hot_encoder] - One-hot encode categories
...
::: hsfs.transformation_function.TransformationType
