...
You can obtain storage connectors using [`FeatureStore.get_storage_connector`][hsfs.feature_store.FeatureStore.get_storage_connector] and [`FeatureStore.get_online_storage_connector`][hsfs.feature_store.FeatureStore.get_online_storage_connector].
